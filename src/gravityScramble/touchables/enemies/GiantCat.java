...
public class GiantCat extends Boss {
	...
	public void drawing(Graphics g, int x, int y) {
		...
		g.fillRect(drawPosX, 480 + y - altitude, 160, 120);
		g.fillRect(drawPosX + 10, 600 + y - altitude, 40, 40);
		g.fillRect(drawPosX + 110, 600 + y - altitude, 40, 40);
		g.fillRect(drawPosX + 40, 440 + y - altitude, 80, 80);
		
		int[] xPoints = {drawPosX + 50, drawPosX + 60, drawPosX + 70};
		int[] yPoints = {440 + y - altitude, 420 + y - altitude, 440 + y - altitude};
		g.fillPolygon(xPoints, yPoints, 3);
		
		int[] xPoints2 = {drawPosX + 90, drawPosX + 100, drawPosX + 110};
		...
		g.drawRect(drawPosX + 40, 440 + y - altitude, 80, 80);
		g.fillRect(drawPosX + 60, 470 + y - altitude, 10, 10);
		g.fillRect(drawPosX + 90, 470 + y - altitude, 10, 10);
		...
		g.fillRect(drawPosX + 55, 490 + y - altitude, 10, 20);
		g.fillRect(drawPosX + 95, 490 + y - altitude, 10, 20);
		
		if (smiling) {
			g.fillRect(drawPosX + 65, 500 + y - altitude, 30, 10);
		} else {
			g.fillRect(drawPosX + 65, 490 + y - altitude, 30, 10);
		}

		g.setColor(cat);
		g.fillRect(drawPosX + 10, 460 + y - altitude, 20, 20);
		g.fillRect(drawPosX + 5, 475 + y - altitude, 5, 10);
		g.fillRect(drawPosX + 30, 475 + y - altitude, 5, 10);
		g.fillRect(drawPosX + 14, 457 + y - altitude, 3, 3);
		g.fillRect(drawPosX + 23, 457 + y - altitude, 3, 3);
		...
		g.drawRect(drawPosX + 10, 460 + y - altitude, 20, 20);
		g.fillRect(drawPosX + 15, 468 + y - altitude, 2, 2);
		g.fillRect(drawPosX + 23, 468 + y - altitude, 2, 2);
		g.drawRect(drawPosX + 5, 475 + y - altitude, 5, 10);
		g.drawRect(drawPosX + 30, 475 + y - altitude, 5, 10);
		
		g.setColor(cat);
		g.fillRect(drawPosX + 130, 460 + y - altitude, 20, 20);
		g.fillRect(drawPosX + 125, 475 + y - altitude, 5, 10);
		g.fillRect(drawPosX + 150, 475 + y - altitude, 5, 10);
		g.fillRect(drawPosX + 134, 457 + y - altitude, 3, 3);
		g.fillRect(drawPosX + 143, 457 + y - altitude, 3, 3);
		...
		g.drawRect(drawPosX + 130, 460 + y - altitude, 20, 20);
		g.fillRect(drawPosX + 135, 468 + y - altitude, 2, 2);
		g.fillRect(drawPosX + 143, 468 + y - altitude, 2, 2);
		g.drawRect(drawPosX + 125, 475 + y - altitude, 5, 10);
		g.drawRect(drawPosX + 150, 475 + y - altitude, 5, 10);
